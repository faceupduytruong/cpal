...
container.innerHTML = `
  ...
  <div onclick="openRightHalfPopup('https://www.facebook.com/groups/lispcad/files/files' + chatParams, 'SmartApp Popup', window.innerWidth, 745)">
    ...
    <h2 class="row-title">Revit AI</h2>
      <div class="image-box">
       <div onclick="openRightHalfPopup('https://www.facebook.com/chieu.nguyenvan.1447' + chatParams, 'SmartApp Popup', window.innerWidth, 745)">
       <img src="https://www.dropbox.com/scl/fi/8iybv02amomuvkhmajhza/Chi-u-Nguy-n.webp?rlkey=d1n4anymb57p29c5cn76j9ybm&st=htz2uarj&raw=1" alt="Ảnh 1">
</div>
        <div class="caption">Chiêu Nguyễn</div>
      </div>
  ...
  <div onclick="openRightHalfPopup('https://www.facebook.com/xaynhalandau.vn/reels/' + chatParams, 'SmartApp Popup', window.innerWidth, 745)">
          <img src="https://www.dropbox.com/scl/fi/xhkfsga7vkari0bqqud6u/X-y-Nh-L-n-u.png?rlkey=vpsraamvpg1efr96q53nrmbcz&st=unayqgdm&raw=1">
</div>
  ...
  <div onclick="openRightHalfPopup('https://www.facebook.com/weodesign.hcm/videos/' + chatParams, 'SmartApp Popup', window.innerWidth, 745)">
          <img src="https://www.dropbox.com/scl/fi/0l3jxzefgpvqamj0nsjv3/Weo-Design.png?rlkey=wbe9m996fucphfz59r8d51mt7&st=r6xxt6tz&raw=1">
</div>
