...
document.addEventListener("DOMContentLoaded", () => {
  // Tạo nội dung popup bằng JS
  const lyricsPopup = document.createElement("div");
  lyricsPopup.id = "lyricsPopup";
  lyricsPopup.className = "popup-hidden";
  lyricsPopup.innerHTML = `
    <div class="popup-content input-content">
      <button id="closeLyricsPopup" class="close-btn">❌</button>
      <h3>Music Station</h3>
      <div class="button-group">
        ...
        <button class="siteBtn" data-url="https://music.youtube.com/">      
          <img src="https://www.dropbox.com/scl/fi/nakg1va0xe4eo5ve0s4z7/Youtube-Music.png?rlkey=gnt0zkr6hkxi5xly6o7ehjk55&st=nqb5ce6k&raw=1" alt="Youtube Music" class="icon-img">
        </button>
